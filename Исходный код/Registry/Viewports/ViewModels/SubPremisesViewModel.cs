...
{
    internal sealed class SubPremisesViewModel : SnapshotedViewModel
    {
        public SubPremisesViewModel()
        ...
        {
            SnapshotDataSource = new DataTable("snapshot_sub_premises")
            {
        ...
        public override void LoadSnapshot()
        {
            ...
            foreach (var row in this["general"].BindingSource)
                SnapshotDataSource.Rows.Add(EntityConverter<SubPremise>.ToArray((DataRowView)row));
        }
    }
}
