...
{
    internal partial class PaymentsAccountHistoryViewport : FormWithGridViewport
    {
        private PaymentsAccountHistoryViewport()
            : this(null, null)
        {
        }

        public PaymentsAccountHistoryViewport(Viewport viewport, IMenuCallback menuCallback)
        ...
        {
            GeneralDataModel = DataModel.GetInstance<PaymentsAccountHistoryDataModel>();
            ...
            GeneralBindingSource.DataSource = ((PaymentsAccountHistoryDataModel)GeneralDataModel).Select((int)ParentRow["id_account"]);
