...
{
    public class PaymentsAccountHistoryDataModel: DataModel
    {
        private const string SelectQuery = @"SELECT pa.id_account,
                                              ...
                                              pm.balance_output_padun,
                                              pm.balance_output_pkk,
        ...
        private PaymentsAccountHistoryDataModel()
        {        
        }

        public static PaymentsAccountHistoryDataModel GetInstance()
        {
            return new PaymentsAccountHistoryDataModel();
        }
