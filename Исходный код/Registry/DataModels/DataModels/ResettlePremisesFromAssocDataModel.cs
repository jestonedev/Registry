...
{
    public sealed class ResettlePremisesFromAssocDataModel: DataModel
    {
        private static ResettlePremisesFromAssocDataModel dataModel = null;
        private static string selectQuery = "SELECT * FROM resettle_premises_from_assoc WHERE deleted = 0";
        private static string deleteQuery = "UPDATE resettle_premises_from_assoc SET deleted = 1 WHERE id_assoc = ?";
        private static string insertQuery = @"INSERT INTO resettle_premises_from_assoc (id_premises, id_process) VALUES (?,?)";
        private static string updateQuery = @"UPDATE resettle_premises_from_assoc SET id_premises = ?, id_process = ? WHERE id_assoc = ?";
        private static string tableName = "resettle_premises_from_assoc";
        ...
        public static ResettlePremisesFromAssocDataModel GetInstance()
        {
        ...
        {
            if (dataModel == null)
                dataModel = new ResettlePremisesFromAssocDataModel(progressBar, incrementor);
            return dataModel;
        }
