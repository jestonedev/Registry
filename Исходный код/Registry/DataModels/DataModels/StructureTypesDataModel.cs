...
namespace Registry.DataModels
{
    public sealed class StructureTypesDataModel : DataModel
    {
        ...
        public int Delete(int id)
        {
            ...
            command.Parameters.Add(connection.CreateParameter<int?>("id_structure_type", id));
            try
            {
        ...
        public int Insert(StructureType structureType)
        {
            ...
            command.Parameters.Add(connection.CreateParameter<string>("structure_type", structureType.structure_type));
            try
            {
        ...
        public int Update(StructureType structureType)
        {
            ...
            command.Parameters.Add(connection.CreateParameter<string>("structure_type", structureType.structure_type));
            command.Parameters.Add(connection.CreateParameter<int?>("id_structure_type", structureType.id_structure_type));
            try
            {
                return connection.SqlModifyQuery(command);
            }
