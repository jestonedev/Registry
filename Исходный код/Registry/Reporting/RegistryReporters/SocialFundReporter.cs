...
{
    internal sealed class SocialFundReporter: Reporter
    {
        public override void Run()
        {
            ReportTitle = "Социальный жилой фонд";
            var arguments = new Dictionary<string, string>();
            arguments.Add("config", Path.Combine(RegistrySettings.ActivityManagerConfigsPath, "registry\\social_fund.xml"));
